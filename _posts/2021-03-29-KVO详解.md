---
layout:     post
title:      Rhythm Park项目讲解
subtitle:   Rhythm Park核心思路
date:       2024-10-20
author:     Rain
...
音律自有其严密的逻辑体系。每个音的高低远近以及互相搭配都可以带给,观者千变万化的听觉感受。 



## 正文

而对听者来说认知音律仍局限于个人认知，对于歌曲音律的主旋律和意境表达无法完全与创作者产生共鸣。而通过将音律以一种 具象化的图形或者图像的形式表达出来。就可以使观者实现更清晰明了的情绪 认同和逻辑感知。在另一方面。声音与图形的结合也可以更丰富演出效果。带给人更新奇的观看体验。音乐可视化也为音乐表现的途径与传播方式提供了另 一种思路，使音乐的艺术生命力 在视觉层面得到了延展。 

区别于从视觉到视觉 的图形生成方式，它实现了从听觉到视觉 的跨界转化，对于视觉符号与图形的 探索有一定的推进作用。 
### Rhythm Park意义

- 特别的对于不可听的群体来说。音律可视化也可以为他们提供一种“看见 声音”的可能。
